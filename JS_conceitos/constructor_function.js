/*
    ...
    * CONSTRUCTOR FUNCTIONS
    / Para isso existem as Constructor Functions, ou seja, Funções Construtoras que são responsáveis por construir novos
    ...
    * THIS KEYWORD
    / O this faz referência ao próprio objeto contruído com Constructor Function
    ...
    * EXERCÍCIOS
    ...
    function Dom(seletor) {
        const elementList = document.querrySelectorAll(seletor);
