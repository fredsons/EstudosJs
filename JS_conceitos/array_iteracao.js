/*
    ...
    * PASSO A PASSO REDUCE
    ...
    a diferença é que este começa a iterar da direita para a esquerda, enquanto o reduce itera da esquerda para a direita.
...
console.log(objetosCurso);
    ...
    const valorTotal = compras.reduce((acumulador, item) => {
        const precoLimpo = +item.preco.replace('R$ ', '').replace(',', '.'); // transforma a string em numero,  retira o R$ e subistitui a virgula por ponto
