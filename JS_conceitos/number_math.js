/*
    ...
    * NUMBER.ISNAN() E NUMBERISINTEGER();

    isNaN() é um método de Number, ou seja, não faz parte do prototipo.
    ...
    * NUMBER.PARSEFLOAT() E NUMBERPARSEINT()
    ...
    * N.TOSTRING(RADIX)
    ...
    Transforma o número em uma string com base do Radix.
    Use o 10 para sistema decimal
    ...
    * N.TOLOCALESTRING(LANG, OPTIONS);
    ...
    Formata o número de acordo com a língua e opões passadas.
    ...
    * EXERCÍCIOS
    ...
    Math.floor(Math.random() * (2000 - 1500 + 1)) + 1050); 

    / Retorne o maior número da lista abaixo
    const numeros = '4, 5, 20, 8, 9';

    const arrayNumeros = numeros.slpit(', ');
