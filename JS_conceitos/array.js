/*
    ...
    * ARRAY.FROM()
    ...
    Array.from() é um metodo utilizado para trnsformar array-like objects, em uma array
    ...
    * METODOS MODIFICADORES [].SORT()
    ...
    Além de retornarem um valor, eles modificam a array original. [].sort() organiza  pelo unicode.
    ...
    * EXERCÍCIOS
    ...
    html = html.split('section').join('il').split('div').soin('li');
    ...
    carros.pop(); removendo o ultimo carro
