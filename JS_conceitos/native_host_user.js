/*
    ...
    * NATIVE
    ...
    Objetos nativos são aqueles definidos na especficação da linguagem e são implementados independente do host.
    ...
    * HOST
    ...
    Objetos do host são aqueles implementados pelo proprio ambiente.
    Por exemplo no browser possuímos objetos do DOM, como DomList, HTMLCollection e outros.
    Em Node.JS os objetos do Host são doferentes, já que não estamos em um ambiente do browser 
    ...
    * USER
    ...
    Objetos do user, são objetos definidos pelo seu aplicativo.
    Ou seja, qualquer objeto que você criar ou que importar de algua biblioteca externa
    ...
    * BIBLIOTECAS
    ...
    Bibliotecas como jQuery foram criadas para resolver o problema de inconsistencias entre browsers e adicionar funcionalidades que não existiam nativamente.
    ...
    * API
    ...
    utilizando Objetos, Métodos e Propriedades, estamos na verdade interagindo com a API do browser
