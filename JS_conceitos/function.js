/*
    ...
    * FUNCTION
    ...
    Toda função é criada com o constructor Function e por isso herda as suas propriedades e métodos 

    function areaQuadrado(lado) {
        rerturn lado * lado;

    }
    const perimetroQuadrdo = new Function('lado', 'return lado * 4');
    ...
    * FUNCTION.APPLY()
    ...
    / Podemos passar null para o valor de this, 
    caso a função não utilize o objeto principal para funcionar
    ...
    * EXERCÍCIOS
    ...
    <section>
        ...
        É um sobrevivente da Era do Gelo, originário do Pleistoceno Superior, cerca de 300 mil anos atrás. É o maior membro remanescente selvagem da família canidae.</p>
