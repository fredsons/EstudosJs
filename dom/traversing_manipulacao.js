/*
    ...
    * OUTERHTML, INNERHTML E INNERTEXT
    ...
    É possivel atribuir um novovalor para as mesms element.innerText = 'Texto novo'
    ...
    * ELEMENT VS NODE
    ...
    Node representa um nó, e pode ser um elemento (Element), texto, comentario, quebra de linha e mais.
    ...
    * Duplique o menu e adicione ele em copy
    const menu = documet.querySelector('.menu');
    ...
    * Selecione o primeiro DT da dl de Faq
    ...
    const prmeiroDt = faq.querySelector('.dt');
