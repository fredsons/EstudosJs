/*
    ...
    * ADICIONAR CLASSES PARA MANIPULÇÃO

    / A ideia de navegação por tabs, é ter uma lista de itens que controla a visualização de uma lista
    de conteúdo. Cada item da lista possui um conteúdo relacionado ao mesmo.
    ...
    * FUNÇÃO CALLBACK
    ...
    / Recebe index como parâmetro para ativar a tab. Sempre que ativar,
    ...
    * ADICIONAR O EVENTO
    ...
    / Neste caso precisamos passar a função anônima no callback, 
    ...
    * ASSIM QUE CARREGAR 
    ...
    Assim identificamos se o JavaScript está abilitado ou não.
